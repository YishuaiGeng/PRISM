...
from prism.online.sparc_gate import SparcGateMixin
...
class GuidedSolver(SparcGateMixin):
    ...
    # === SPARC π-gate ===
    # The SPARC/SBW selective-abstention gate (_sparc_gate + 7 helpers) was
    # extracted to prism/online/sparc_gate.py:SparcGateMixin, which this class
    # inherits (see the class declaration above). Activated only when sparc=True.
    # See docs/sparc/ and scripts/sparc/.
